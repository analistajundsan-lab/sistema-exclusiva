...
active_users_total = Gauge("active_users_total", "Active users currently logged in")

incidents_created_total = Counter("incidents_created_total", "Total incidents created")

swaps_created_total = Counter("swaps_created_total", "Total swaps created")
